...
class material {
    public:
        ...
        __device__ virtual bool scatter(
            const ray& r_in, const hit_record& rec, color& attenuation, ray& scattered, curandState* rs
        ) const {
            return false;
        }
};
...
class lambertian : public material {
    public:
        ...
        __device__ bool scatter(
            ...
            vec3 scatter_direction = rec.normal + random_unit_vector(rs);
...
class metal : public material {
    public:
        ...
        __device__ bool scatter(
            ...
            reflected = unit_vector(reflected) + (fuzz * random_unit_vector(rs));
...
class dielectric : public material {
    public:
        ...
        __device__ bool scatter (
            ...
            if (cannot_refract || reflectance(cos_theta, ri) > curand_uniform(rs)) {
